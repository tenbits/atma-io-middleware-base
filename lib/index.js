...
var CacheItem = /** @class */ (function (_super) {
    ...
    CacheItem.prototype.write = function (currentInput, currentOutput) {
    ...
    CacheItem.prototype.onCacheFileLoaded = function (content) {
        var _a = this.deserialize(content), inputHash = _a[0], outputContent = _a[1];
...
var Middleware = /** @class */ (function () {
    ...
    Middleware.prototype.process = function (file, config, method) {
        ...
        if (item != null) {
            item.write(inputContent, file.content);
        }
    };
