...
var io_ = require("atma-io");
var utils = require("atma-utils");
exports.utils = utils;
var globalIo = global.io;
var io = globalIo && globalIo.File ? globalIo : io_;
exports.io = io;
;
					...
					if (isObject(_src_package_private) && isObject(module.exports)) {
						Object.assign(_src_package_private, module.exports);
						return;
					}
...
Object.defineProperty(exports, "__esModule", { value: true });
var package_private_1 = _src_package_private;
...
var FileLogger = (function (_super) {
    ...
    FileLogger.prototype.release = function () {
        package_private_1.io.File.write(this.options.file, this.buffer.join('\n'));
    };
...
var SourceMapFile = (function (_super) {
    ...
    SourceMapFile.prototype.read = function (opts) {
        ...
        if (path == null)
            return null;
        var file = new package_private_1.io.File(path);
        file.read(opts);
    ...
    SourceMapFile.prototype.exists = function (check) {
        ...
        var path = this.getSourcePath();
        return path != null
            ? package_private_1.io.File.exists(path)
            : false;
    };
...
var VirtualFile = (function (_super) {
    ...
    VirtualFile.prototype.read = function (opts) {
        this.content = '';
        package_private_1.io.File.processHooks('read', this, opts, null);
        return this.content;
    };
    VirtualFile.prototype.readAsync = function (opts) {
        ...
        package_private_1.io.File.processHooks('read', this, opts, function (error) {
            if (error) {
                dfr.reject(error);
                return;
            }
...
function try_createFileInstance(base, url, onSuccess, onFailure) {
    var path = package_private_1.io.Uri.combine(base, url);
    package_private_1.io.File
        .existsAsync(path)
        .then(function (exists) {
        if (exists)
            return onSuccess(new package_private_1.io.File(path));
        onFailure();
    }, onFailure);
}
;
...
function try_createFileInstance_viaStatic(config, url, onSuccess, onFailure) {
    ...
    var file = new package_private_1.io.File(_resolveStaticPath(url, config));
...
var Middleware = (function () {
    ...
    Middleware.prototype.register = function (io_, extraOptions) {
 ...
 * }
 */
function create(middlewareDefintion, io_) {
    ...
    var ioLib = io_ || package_private_1.io;
    if (ioLib != null) {
        middleware.register(package_private_1.io);
    }
    return middleware;
}
